import { isItemVisible, isFiltering } from "../lib/menu-filter-predicates.js";
...
export default class MenuFilter {
  ...
  applyFilters() {
    ...
    this.items.forEach((item) => {
      if (isItemVisible(item, this.state)) {
    ...
    this.sections.forEach((section) => {
      const hasVisibleChildren =
        section.querySelector('[data-filter-item]:not([style*="display: none"])') !== null;
