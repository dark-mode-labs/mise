...
export default class TabHead {
  ...
  setState(isActive) {
    ...
    const stateClasses =
      this.el.getAttribute(isActive ? "data-tab-active-class" : "data-tab-inactive-class") || "";
    const stateStyles =
      this.el.getAttribute(isActive ? "data-tab-active-styles" : "data-tab-inactive-styles") || "";
